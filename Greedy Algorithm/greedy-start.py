...
while swaps > 0:
    ...
    # Swap adjacent items and append to dictionary
    current_path = swap(current_path)
    current_path_cost = calculateRoute(current_path)
    dict[current_path_cost] = 
    print(solutions)


    # Add dictionary items to dataframe
    # Count down from total swaps
    swaps -= 1

# Make index start from city 1


                    
# best_solutions = df_solutions.sort_values(by=['Cost'])
